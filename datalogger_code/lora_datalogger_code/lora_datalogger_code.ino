...
void send_data_overGSM(){
  ...
  */
  ...
  //   }
  // }
  J *req_queue_data = notecard.newRequest("note.template");
  ...
  if (req_queue_data != NULL) {
        ...
        if (body != NULL) {
            ...
            for (int i = 0; i < sensor.get_nb_values(); i++) {
                ...
                JAddStringToObject(sample, "value", TSTRING(12)); // Taille à ajuster
                JAddStringToObject(sample, "epoch", TSTRING(20));
            }
            JAddStringToObject(req_queue_data, "file", "dataLORA.qo");
            JAddNumberToObject(req_queue_data, "port", 6);
            JAddStringToObject(req_queue_data, "format", "compact");
  ...
  //  JAddStringToObject(req, "format", "compact");
    req_queue_data = notecard.newRequest("note.add");
    if (req_queue_data != NULL) {
        JAddStringToObject(req_queue_data, "file", "dataLORA.qo");

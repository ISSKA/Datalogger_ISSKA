...
void setup() {
  ...
  readingID ++;
  if (readingID == 1){
    deep_sleep_mode(wakeUpInterval-42); //28 is the time shift for the program execution
  }
  else {
    deep_sleep_mode(wakeUpInterval-12); //2 is the time shift for the program execution
  }
}

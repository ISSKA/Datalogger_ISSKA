...
void setup() {
  ...
  //RTC.adjust(DateTime(2022, 12, 20, 9, 35, 0));
  ...
  readingID ++;
  if (readingID == 1){
    deep_sleep_mode(wakeUpInterval-27); //28 is the time shift for the program execution
  }
  else {
    deep_sleep_mode(wakeUpInterval-1); //2 is the time shift for the program execution
  }
}

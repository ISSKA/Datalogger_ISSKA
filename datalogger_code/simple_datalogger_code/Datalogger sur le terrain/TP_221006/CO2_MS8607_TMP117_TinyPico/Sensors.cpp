...
String Sensors::getFileHeader () {
  return "temperature;temp_HP;pressure;humidityBOX;humidity;CO2;";
}
...
String Sensors::getFileData () {
  ...
  sprintf(str, "%s;%s;%s;%s;%s;%s",
     String(mesures.temp1, 3).c_str(),String(mesures.tempHP, 5).c_str(), String(mesures.press1, 3).c_str(), String(mesures.humidityBOX, 3).c_str(), String(mesures.humidity, 3).c_str(), String(mesures.co2).c_str());

...
void setup() {
  ...
  readingID ++;
  if (readingID == 1){
    deep_sleep_mode(wakeUpInterval-41); //28 is the time shift for the program execution
  }
  else {
    deep_sleep_mode(wakeUpInterval-11); //2 is the time shift for the program execution
  }
}

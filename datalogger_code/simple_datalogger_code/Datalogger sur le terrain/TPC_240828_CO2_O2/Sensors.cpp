...
#define BMP581_sensor_ADRESS 0x47 //I2C adress of the BMP581 set on the PCB
...
String names[]={"Vbatt","tempSHT","humSHT","tempBMP","pressBMP","CO2","CO2_H","CO2_T","O2","V_O2"}; //update this list if you add sensors!!!
...
void Sensors::measure() {
  ...
  float O2_voltage_tcomp=0.002864*values[1]+1.124689;
  Serial.print("Voltage: ");Serial.println(voltage);

  values[8] = (voltage*0.2095/O2_voltage_tcomp)*100;
  values[9]=voltage;
    //values[8] = 1;
   //values[9]=2;

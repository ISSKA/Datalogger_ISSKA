...
void get_next_rounded_time(){ 
  ...
  u8x8.clear();
  u8x8.setCursor(0, 0);
  u8x8.println("start time:\n");
  u8x8.println(start_datetime.timestamp(DateTime::TIMESTAMP_FULL).substring(0,10));
  u8x8.println(start_datetime.timestamp(DateTime::TIMESTAMP_FULL).substring(11,19));
  delay(5000);
}

...
String names[]={"Vbatt","tempSHT","humSHT","tempBMP","pressBMP","pressMS","htWat"};
...
void Sensors::measure() {
  ...
  delay(50);
  tcaselect(7);
  delay(50); //delay for the multiplexer
  ms5837_sensor.init() ;
  delay(300);
  ms5837_sensor.setModel(MS5837::MS5837_02BA);
  ms5837_sensor.read();
  delay(300);
  values[5]=ms5837_sensor.pressure()+2.8;
  delay(100);
  ...
  Wire.setClock(50000);
  delay(200);
  values[6] = (values[5]-values[4])*10/9.81;//water height in cm is (water_pressur-air_pressure)*10/g

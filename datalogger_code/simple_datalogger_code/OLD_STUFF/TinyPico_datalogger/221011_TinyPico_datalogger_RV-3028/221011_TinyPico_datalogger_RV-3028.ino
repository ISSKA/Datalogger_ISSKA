...
const unsigned int interruptPin = 4; // Connected to pin 2 of RV-3028-C7
...
void setup() {
  ...
  readingID ++;
  if (readingID == 1){
    deep_sleep_mode(wakeUpInterval); //28 is the time shift for the program execution
  }
  else {
    deep_sleep_mode(wakeUpInterval); //2 is the time shift for the program execution
  }
}

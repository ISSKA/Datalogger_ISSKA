...
//Library for TinyS3, replace the tinypico library
#include <UMS3.h>
UMS3 tinyS3;
...
#define Enable5VPIN 4 //27 sur TinyPico turns the 3V to 5V converter on if switched to high
#define MOSFET_SENSORS_PIN 2 // 14 sur TinyPico pin to control the power of the sensors, the screen and sd card reader

//SD card
#define SD_CS_PIN 34//5 sur TinyPico Define the pin of the tinypico connected to the CS pin of the SD card reader
...
void deep_sleep_mode(int sleeping_time){ 
  ...
  tinyS3.setPixelPower(false); //LED of the TinyPico
  ...
  esp_sleep_enable_ext0_wakeup(GPIO_NUM_3, 0); //2nd param. is logical level of trigger signal (tinypico is wake-up when signal is low in this case)

...
String names[]={"Vbatt","tempSHT","humSHT","tempBMP","pressBMP","Windspd","Winddir","WindGust","WindT"}; //update this list if you add sensors!!!
...
void Sensors::measure() {
  ...
  delay(300);
  values[5]=anem.wSpd; //pressBMP (in millibar)
  values[6]=anem.wDir;
  values[7]=anem.wGst;
  values[8]=anem.wTmp;
  delay(100);

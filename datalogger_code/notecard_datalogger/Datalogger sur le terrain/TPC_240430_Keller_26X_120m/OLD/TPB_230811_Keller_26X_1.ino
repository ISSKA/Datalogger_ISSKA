...
void setup(){ //The setup is recalled each time the micrcontroller wakes up from a deepsleep
  ...
  Wire.setClock(10000); // set I2C clock frequency to 50kHz which is rather slow but more reliable //change to lower value if cables get long
...
void put_usefull_values_on_display(){
  ...
  sensor.measure();   //measure all sensors to display the values

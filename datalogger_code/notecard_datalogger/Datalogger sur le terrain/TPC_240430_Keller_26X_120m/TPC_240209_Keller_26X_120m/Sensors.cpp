...
String names[]={"Vbatt","tempSHT","humSHT","tempBMP","pressBMP","tempWAT","pressWAT","htWAT"}; //update this list if you add sensors!!!
...
void Sensors::measure() {
  ...
  values[6]=waterPressureBar*1000;  //value in mbar
  values[7]=waterDepthM*100;  //value in cm 
  values[5]=waterTempertureC;
  delay(100);
  Serial1.end();
  delay(50);
  tcaselect(3);

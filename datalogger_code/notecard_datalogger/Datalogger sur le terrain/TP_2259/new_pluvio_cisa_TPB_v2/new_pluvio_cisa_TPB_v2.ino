...
void send_data_overGSM(){ //send several measurements all at once over GSM
  ...
  */
  ...
  if(synchronize_notecard()){ //connect the notecard
    ...
    String sensor_names[num_sensors+1] = {"VBat_Volt","temp_SHT_degC","humSHT_percentage","tempBMP_degC","pressBMP_mbar","tempPluv_degC","presPluv_mbar","presWat_mbar","htWat_cm"}; //change this if you add more sensors!!!

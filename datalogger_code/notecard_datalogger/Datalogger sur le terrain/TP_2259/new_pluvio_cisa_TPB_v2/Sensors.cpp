...
String Sensors::serialPrint() { //Display sensor mesures to Serial for debug purposes
  ...
  sensor_values_str = sensor_values_str + "humSHT: " + String(mesures.humSHT,3) + "\n";
  sensor_values_str = sensor_values_str + "tempBMP: " + String(mesures.tempBMP,3) + "\n";
  sensor_values_str = sensor_values_str + "pressBMP: " + String(mesures.pressBMP,3) + "\n";
  sensor_values_str = sensor_values_str + "tempPlv: " + String(mesures.tempPluv,3) + "\n";
  sensor_values_str = sensor_values_str + "presPlv: " + String(mesures.presPluv,3) + "\n";
  sensor_values_str = sensor_values_str + "presWat: " + String(mesures.presWat,3) + "\n";

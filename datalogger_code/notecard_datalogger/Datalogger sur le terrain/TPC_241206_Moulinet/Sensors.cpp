...
String names[] = {"Vbatt", "tempSHT", "humSHT", "tempBMP", "pressBMP","velAmsler"}; // Mise à jour si vous ajoutez des capteurs !
const int nb_values = sizeof(names) / sizeof(names[0]);
float values[nb_values];
int decimals[] = {2, 3, 1, 2, 1, 3}; // Nombre de décimales pour chaque capteur

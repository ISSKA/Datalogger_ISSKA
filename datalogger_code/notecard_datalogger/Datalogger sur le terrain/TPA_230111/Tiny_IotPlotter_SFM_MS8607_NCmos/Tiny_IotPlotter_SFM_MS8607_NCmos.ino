...
void setup()
{
  ...
  //RTC.adjust(DateTime(2023, 01, 13, 19, 02, 0));
  ...
  else if (readingID >= measurementSendingThreshold)//Data are sent to notehub
  {
    ...
    int wakeUpIntervalAfterSending = (int)(wakeUpInterval - SendingTime_s - InitTime_s - 1);
...
unsigned long InitializeNoteHubConnection()
{
  ...
  //Turn on the mosfet controlling the notecard

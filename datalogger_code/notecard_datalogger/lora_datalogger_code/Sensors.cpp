...
String names[]={"Vbatt","T_SHT","H_SHT","T_BMP","P_BMP",}; //update this list if you add sensors!!!
...
void Sensors::measure() {
 ...
 // tiny.begin();
  ...
  // delay(1000);
  // PH.send_read_with_temp_comp(RTD.get_last_received_reading());                               //send readings from temp sensor to EC sensor                                                                                     //if the temperature reading is invalid
